...
class Dice:
    ...
    def draw(self, screen):
        ...
        while self.count < self.duration:
            screen.blit(pygame.image.load("img/dice" + str(self.dice) + "Wit.png"), (0, 0))
            pygame.display.flip()
            time.sleep(1)
            self.count += 1
                ...
                if player == 1:
                    if steps > 0:
                        ...
                        if player1.Position == (290, 92):
                            ...
                            conn = psycopg2.connect(database="score", user="postgres",
                                                    password="Cornelis1604")  # Eigen wachtwoord invoeren
                            cur = conn.cursor()
                        ...
                        if player2.PlayerX == 0 and 122 <= player1.PlayerY < 572:

                            Vragen.vragen()
                        if player2.PlayerX == 190 and 122 <= player1.PlayerY < 572:

                            Vragen.vragen()
                        if player2.PlayerX == 380 and 122 <= player1.PlayerY < 572:

                            Vragen.vragen()
                        if player2.PlayerX == 570 and 122 <= player1.PlayerY < 572:
                    ...
                    if steps > 0:
                        ...
                        if player3.PlayerX == -190 and 122 <= player2.PlayerY < 572:

                            Vragen.vragen()
                        if player3.PlayerX == 0 and 122 <= player2.PlayerY < 572:

                            Vragen.vragen()
                        if player3.PlayerX == 190 and 122 <= player2.PlayerY < 572:

                            Vragen.vragen()
                        if player3.PlayerX == 380 and 122 <= player2.PlayerY < 572:
                    ...
                    if steps > 0:
                        ...
                        if player4.PlayerX == -380 and 122 <= player3.PlayerY < 572:

                            Vragen.vragen()
                        if player4.PlayerX == -190 and 122 <= player3.PlayerY < 572:

                            Vragen.vragen()
                        if player4.PlayerX == 0 and 122 <= player3.PlayerY < 572:
                    ...
                    if steps > 0:
                        ...
                        if player1.PlayerX == -570 and 122 <= player4.PlayerY < 572:
                            print("P4 ")
                            Vragen.vragen()
                        if player1.PlayerX == -380 and 122 <= player4.PlayerY < 572:
                            print("P4 ")
                            Vragen.vragen()
                        if player1.PlayerX == -190 and 122 <= player4.PlayerY < 572:
                            print("P4 ")
                            Vragen.vragen()
                        if player1.PlayerX == 0 and 122 <= player4.PlayerY < 572:
                            print("P4 ")
                            Vragen.vragen()
